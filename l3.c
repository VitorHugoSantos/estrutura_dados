...
l C(l *nodoC){
    ...
    res->proximo = (primeiro->id + ultimo->id);
    ultimo->proximo = NULL;
    primeiro->proximo = NULL;
    free(ultimo);
    free(primeiro);
...
void copia(l* nodo0, l *nodoA, l *nodoB, l *nodoC){
    nodoA->proximo = nodo0->proximo;
    nodoB->proximo = nodo0->proximo;
    nodoC->proximo = nodo0->proximo;
    while(nodo0->proximo){
        nodoA = nodoA->proximo;
        nodoB = nodoB->proximo;
        nodoC = nodoC->proximo;
